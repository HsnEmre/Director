...
public sealed class OllamaOptions
{
    ...
    public int SceneNumPredict { get; set; } = 3072;
    public int SceneFreshRetryNumPredict { get; set; } = 3072;
    public int SceneRepairNumPredict { get; set; } = 2048;
    public double SceneStructuredTemperature { get; set; } = 0.2;
    public double SceneStructuredTopP { get; set; } = 0.8;
    public int SceneStructuredTopK { get; set; } = 40;
    public double SceneStructuredRepeatPenalty { get; set; } = 1.15;
    public int SceneStructuredRepeatLastN { get; set; } = 2048;
    public bool RepetitionGuardEnabled { get; set; } = true;
    public int RepetitionGuardMinCharacters { get; set; } = 600;
    public int RepetitionGuardMinBlockCharacters { get; set; } = 48;
    public int RepetitionGuardMaxBlockCharacters { get; set; } = 512;
    public int RepetitionGuardMinConsecutiveRepeats { get; set; } = 4;
