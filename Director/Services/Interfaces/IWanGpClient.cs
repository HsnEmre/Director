...
public interface IWanGpClient
{
    ...
    Task<IReadOnlyList<WanGpModelInfo>> GetAvailableAudioModelsAsync(CancellationToken cancellationToken = default);
    ...
    Task<WanGpGenerationSubmission> SubmitVideoGenerationAsync(
        ...
        CancellationToken cancellationToken = default);
    Task<WanGpGenerationSubmission> SubmitAudioGenerationAsync(
        IReadOnlyDictionary<string, object?> source,
        CancellationToken cancellationToken = default);
